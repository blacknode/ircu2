...
extern int m_language(struct Client*, struct Client*, int, char*[]);
...
extern int ms_module(struct Client*, struct Client*, int, char*[]);
...
extern int ms_language(struct Client*, struct Client*, int, char*[]);
